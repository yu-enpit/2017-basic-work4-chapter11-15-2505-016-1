...
public class MainActivity extends AppCompatActivity
    ...
    private void showDiaryList() {
        ...
        Fragment fragment = manager.findFragmentByTag("DairyListFragment");
        if(fragment == null) {
            fragment = new DiaryListFragment();
            FragmentTransaction transaction = manager.beginTransaction();
            transaction.add(R.id.content, fragment, "DairyListFragment");
            transaction.commit();
        }
    }

    @Override
    public void onAddDairySelected() {
        ...
        InputDiaryFragment inputDairyFragment =
                InputDiaryFragment.newInstance(nextId);
        FragmentManager manager = getSupportFragmentManager();
        FragmentTransaction transaction = manager.beginTransaction();
        transaction.replace(R.id.content, inputDairyFragment,
                "InputDiaryFragment");
